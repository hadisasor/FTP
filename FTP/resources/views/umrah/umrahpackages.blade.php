                          ...
                          @if ($umrahpackage['packageName'] == 'Deluxe')
                            ...
                            <div class="content">
                              <div class="row" data-aos="zoom-in" data-aos-delay="50">
                                  <h3>{{$umrahpackage['stayingDays']}} day of stay</h3>
                                  <div class="image-container col-xl-6"> <img src="{{asset('img/Ka3bah.jpg')}}"> </div> 
                                  <div class="hajjpricing col"><h4>{{$umrahpackage['stayingDays']}} DAY<br> 125,000bht </h4></div>
                              </div>
                              <div class="row">
                                <div class="details"  data-aos="zoom-in" data-aos-delay="50">
                                  ...
                                  <div class="hot-location"><p>Makkah hotel:{{$umrahpackage['makkaHotel']}}
                                    <br>Madinah hotel: {{$umrahpackage['madinaHotel']}}
                            ...
                            <div class="content">
                              ...
                              <div class="row">
                                <div class="details"  data-aos="zoom-in" data-aos-delay="50">
                                  ...
                                  <div class="hot-location"><p>Makkah hotel:{{$umrahpackage['makkaHotel']}}
                                    <br>Madinah hotel: {{$umrahpackage['madinaHotel']}}
                                    <br>Group: {{$umrahpackage['groupNumber']}} </p></div>
                                    {{-- <div class="hot-name"><p>Al-Janadiryah<br>Al-Tayibah<br> 3 </p></div> --}}
                                </div>
                              </div>    
                                <div class="book-container">
                        ...
                        <div class="hajjpackages"> 
                          ...
                          <div class="content">
                            ...
                            <div class="row">
                              ...
                              <div class="book-container">
                                <a href="hajjpackage/{{$umrahpackage['id']}}" class="book btn-get-started scrollto">view details</a>
                              </div>
                          </div>
