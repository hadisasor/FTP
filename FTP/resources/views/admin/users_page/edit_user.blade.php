@include('admin/includes.header')
        ...
        <div class="content">
           ...
           @php
           $route = Route::current()->getName();@endphp

           <div class="bg-light rounded h-100 p-4">
            <form action="/edit_user/{{$user['id']}}" method="POST">
               {{ csrf_field() }}

            <h1 class="mb-4">({{$user['id']}}) {{ucfirst($route)}} user information</h1>
           ...
           <div class="row">
                  <div class="col-xl-6">
                        <div class="form-floating mb-3">
                           <input type="text" class="form-control" id="floatingInput"
                              name="fstname" value="{{$user['fstname']}}">
               ...
               <div class="col-xl-6">
                     <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput"
                           name="lstname" value="{{$user['lstname']}}">
                  ...
                  <div class="col-xl-6">
                     <div class="form-floating mb-3">
                        <select class="form-select" id="floatingSelect"
                           ...
                           <option @if ($user['userType'] == 'Tokseh') {{'selected'}} @endif value="Tokseh">Tokseh</option>
                           <option @if ($user['userType'] == 'Pilgrim') {{'selected'}} @endif value="Pilgrim">Pilgrim</option>
                        </select>
           ...
           <div class="col">
            ...
            @if ($route == 'pilgrim')
            <a href="{{route('pilgrims')}}" class="deletebtn btn-primary">cancel </a>
            @elseif ($route == 'tokseh')
            <a href="{{route('toksehs')}}" class="deletebtn btn-primary">cancel </a>
            @endif
            </div>
