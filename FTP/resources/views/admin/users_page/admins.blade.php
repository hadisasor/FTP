                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$user['lstname']}}</td>
                            <td>{{$user['email']}}</td>
                            <td><a href="/admin/admins/{{$user['id']}}" class="editbtn btn-primary" type="submit">Edit</a></td>
                            @if ($user['fstname'] == 'Eyad')
                            <td></td>
                            @else
                            <td><a class="deletebtn btn-primary" href="/delete_admin/{{$user['id']}}">Delete</a></td>
                            @endif
