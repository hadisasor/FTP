    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1 style="font-size: 270%;">Welcome <br>to Yosr for Hajj and Umrah</h1> 
          <p>convenience website for serving Thai pilgrims, Yosr, an Arabic word which means convenience,
             and this website is willing to try it’s best to accomplish the goal of making Hajj and Umrah process and procedures easier and more convenient, We will be there with you for every step of the way, from the moment you make your intention till the completion of your Hajj, Umrah and Ziyarat.</p>
